                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12 d-flex flex-row">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <input type="text" id="prenomForm" class="form-control" name="prenomForm" placeholder="Prenom" value="${employee.prenom}" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-12 d-flex flex-row">
                                            ...
                                            <div class="p-2">
                                                ...
                                                <input type="text" id="codePostalForm" class="form-control" name="codePostalForm" placeholder="Code Postal" value="${employee.codepostal}">
                                            </div>
                                        </div>
                                    </div>
